...
----------------------------------------------------------------------
<p>
	For information on new features and bug fixes read the <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.4.0/lamw_manager/docs/release_notes.md#v040---jun-19-2021"><em>Release Notes</em></a>
</p>
...
<p>
	For more info read <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.3.6/lamw_manager/docs/man.md"><strong>LAMW Manager v0.4.0 Manual</strong></a>
</p>	
