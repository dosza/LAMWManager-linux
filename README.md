...
In Lazarus versions > 2.0.12 it fails when trying to insert onClick method in LAMW projects.
1) Close LAMW4Linux
...
Release Notes:
---
For information on new features and bug fixes read the [*Release Notes*](https://github.com/dosza/LAMW4Linux-installer/blob/v0.4.0/lamw_manager/docs/release_notes.md#v0406---dec-13-2021)
