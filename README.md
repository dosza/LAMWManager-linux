...
----------------------------------------------------------------------
<p>
	For information on new features and bug fixes read the <a href="https://github.com/dosza/LAMW4Linux-installer/blob/v0.4.1/lamw_manager/docs/release_notes.md#v0411----aug-5-2021"><em>Release Notes</em></a>
</p>
...
<p>
	For more info read <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.4.1/lamw_manager/docs/man.md"><strong>LAMW Manager v0.4.1 Manual</strong></a>
</p>	
