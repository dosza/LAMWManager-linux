...
+	Click here to download [*LAMW Manager Setup*](https://github.com/dosza/LAMWManager-linux/releases/download/v0.5.9/lamw_manager_setup.sh)
...
Release Notes:
---
For information on new features and bug fixes read the [*Release Notes*](https://github.com/dosza/LAMWManager-linux/blob/v0.5.x/lamw_manager/docs/release_notes.md##v0591---dec-27-2023)
...
For more info read [**LAMW Manager v0.5.9 Manual**](https://github.com/dosza/LAMWManager-linux/blob/v0.5.x/lamw_manager/docs/man.md)
