...
+	Click here to download [*LAMW Manager Setup*](https://raw.githubusercontent.com/DanielOliveiraSouza/LAMW4Linux-installer/master/lamw_manager/assets/lamw_manager_setup.sh)
...
Release Notes:
---
For information on new features and bug fixes read the [*Release Notes*](https://github.com/DanielOliveiraSouza/LAMWAutoRunScripts/blob/master/lamw_manager/docs/classic-install.md)
...
For more info read [**LAMW Manager v0.4.0 Manual**](https://drive.google.com/open?id=1CeDDpuDfRwYrKpN7VHbossH6GfZUfqjm)
