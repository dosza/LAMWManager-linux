...
----------------------------------------------------------------------
<p>
	For information on new features and bug fixes read the <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.3.5/lamw_manager/docs/release_notes.md#v035---july-20-2020"><em>Release Notes</em></a>
</p>
...
<p>
	For more info read <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.3.5/lamw_manager/docs/man.md"><strong>LAMW Manager v0.3.5 Manual</strong></a>
</p>	
