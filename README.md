...
<ul>
	<li><a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.3.6/lamw_manager/docs/debian-requerements.md#openjdk-on-debian-10">Debian/GNU Linux 10</a></li>
...
----------------------------------------------------------------------
<p>
	For information on new features and bug fixes read the <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.3.6/lamw_manager/docs/release_notes.md#v0362---may-6-2021"><em>Release Notes</em></a>
</p>
...
<p>
	For more info read <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.3.6/lamw_manager/docs/man.md"><strong>LAMW Manager v0.3.6 Manual</strong></a>
</p>	
