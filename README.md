...
----------------------------------------------------------------------
<p>
	For information on new features and bug fixes read the <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.4.0/lamw_manager/docs/release_notes.md#v040---jun-20-2021"><em>Release Notes</em></a>
</p>
