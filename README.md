...
----------------------------------------------------------------------
<p>
	For information on new features and bug fixes read the <a href="https://github.com/dosza/LAMW4Linux-installer/blob/v0.4.0/lamw_manager/docs/release_notes.md#v0402---jul-27-2021"><em>Release Notes</em></a>
</p>
