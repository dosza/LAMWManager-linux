...
Release Notes:
---
For information on new features and bug fixes read the [*Release Notes*](https://github.com/dosza/LAMWManager-linux/blob/v0.4.4/lamw_manager/docs/release_notes.md#v044---dec-31-2021)
...
For more info read [**LAMW Manager v0.4.4 Manual**](https://github.com/dosza/LAMWManager-linux/blob/v0.4.4/lamw_manager/docs/man.md)
