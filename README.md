...
Release Notes:
---
For information on new features and bug fixes read the [*Release Notes*](https://github.com/dosza/LAMWManager-linux/blob/v0.4.5/lamw_manager/docs/release_notes.md#v045---jan-26-2022)
...
For more info read [**LAMW Manager v0.4.5 Manual**](https://github.com/dosza/LAMWManager-linux/blob/v0.4.5/lamw_manager/docs/man.md)
