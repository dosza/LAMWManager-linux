...
----------------------------------------------------------------------
<p>
	For information on new features and bug fixes read the <a href="https://github.com/DanielOliveiraSouza/LAMW4Linux-installer/blob/v0.3.5/lamw_manager/docs/release_notes.md#v035--r1--august-6-2020"><em>Release Notes</em></a>
</p>
